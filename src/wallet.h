...
enum ZerocoinSpendStatus {
    ZBTAD_SPEND_OKAY = 0,                            // No error
    ZBTAD_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZBTAD_WALLET_LOCKED = 2,                         // Wallet was locked
    ZBTAD_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZBTAD_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZBTAD_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZBTAD_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZBTAD_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZBTAD_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZBTAD_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZBTAD_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZBTAD_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZBTAD_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZBTAD_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZBTAD_SPENT_USED_ZBTAD = 14                       // Coin has already been spend
};
