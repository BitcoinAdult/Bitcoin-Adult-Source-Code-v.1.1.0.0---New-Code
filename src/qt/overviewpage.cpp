...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, CAmount nZerocoinBalance, QString& sBTADPercentage, QString& szBTADPercentage)
{
    int nPrecision = 2;
    ...
    szBTADPercentage = "(" + QLocale(QLocale::system()).toString(dzPercentage, 'f', nPrecision) + " %)";
    sBTADPercentage = "(" + QLocale(QLocale::system()).toString(dPercentage, 'f', nPrecision) + " %)";
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    //ui->labelBTADPercent->setText(sPercentage);
    ui->labelzBTADPercent->setText(szPercentage);
    ...
    ui->labelzBTADPercent->setToolTip(automintHelp);
