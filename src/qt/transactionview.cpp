                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BitcoinAdult from zBitcoinAdult"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBitcoinAdult"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBitcoinAdult));
